...
[ApiController]
[Authorize]
public class StoresApiController(ILogger<StoresApiController> logger, DataServices database) : ControllerBase
{
    private readonly DataServices _database = database;
    private readonly ILogger<StoresApiController> _logger = logger;
